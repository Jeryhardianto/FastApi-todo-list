...
class ServiceTodo:
    ...
    def get_list_todo(
        ...
        match_filter = {"owner_id": current_user.id}
    ...
    def insert(
       ...
       try:
           ...
           todo = TodoSchema.from_orm(todo).dict()
           return Response(message="Todo created", data=todo)   
    ...
    def update(self, id: int, todo_data: TodoUpdate, current_user: TokenData):
        ...
        try:
            ...
            todo = TodoSchema.from_orm(todo).dict()
            return Response(message="Todo updated", data=todo)
        except Exception as e:
            raise HTTPException(status_code=400, detail=str(e))
    ...
    def is_done(self, id: int, todo_data: TodoIsDone, current_user: TokenData):
        ...
        try:
            ...
            todo = TodoSchema.from_orm(todo).dict()
            return Response(message="Todo status updated", data=todo)
        except Exception as e:
            raise HTTPException(status_code=400, detail=str(e))
    ...
    def delete(self, id: int, current_user: TokenData):
        ...
        try:
            ...
            todo = TodoSchema.from_orm(todo).dict()
            return Response(message="Todo deleted", data=todo)
        except Exception as e:
            raise HTTPException(status_code=400, detail=str(e))
